...
local thirdpartycom_path  = "/nopt/nrel/apps/eyas/cpe-deps"
...
--local craympichpackages_path = "/nopt/nrel/apps/eyas/spack/modules/gcc/12.2.1/cray-mpich-8.1.28/gcc-12.2.1"
local craympichpackages_path = "{{ [NSP_install_root, 'spack/modules/gcc/12.2.1/cray-mpich-8.1.28/gcc-12.2.1'] | path_join }}"
...
prepend_path{"MODULEPATH", '/nopt/nrel/apps/eyas/craympich_packages', priority=10}
